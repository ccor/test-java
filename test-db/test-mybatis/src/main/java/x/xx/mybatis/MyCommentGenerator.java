...
public class MyCommentGenerator implements CommentGenerator {
    ...
    public void addFieldComment(Field field, IntrospectedTable introspectedTable, IntrospectedColumn introspectedColumn) {
        ...
        field.addJavaDocLine("/**");
        multiLineJavaDoc(field, introspectedColumn.getRemarks());
        field.addJavaDocLine(" */");
    }

    private void multiLineJavaDoc(Field field, String s){
...
//        method.addJavaDocLine(" */");
    ...
    public void addModelClassComment(TopLevelClass topLevelClass, IntrospectedTable introspectedTable) {
        ...
        topLevelClass.addJavaDocLine(" *" );
        // arg0.addJavaDocLine("* "+compilationUnit.getType().getShortName()+".java");
        // arg0.addJavaDocLine("* Copyright(C) 2017-2020 fendo公司");
